...
extern short cDirs[8][2];
extern short tDirs[3][3];
extern short impaleDirs[8];
...
extern char itemCovers[NUMBER_SCROLL_KINDS][30];
extern char coverPhrases[NUMBER_COVER_PHRASES][30];
extern char itemColors[NUMBER_ITEM_COLORS][30];
extern char itemChemistry[NUMBER_ITEM_CHEMISTRY][30];
...
extern char itemMaterials[NUMBER_ITEM_MATERIALS][30];

extern char itemColorsRef[NUMBER_ITEM_COLORS][30];
extern char itemChemistryRef[NUMBER_ITEM_CHEMISTRY][30];
...
extern char itemMaterialsRef[NUMBER_ITEM_MATERIALS][30];
...
extern boltRunic boltRunicCatalog[NUMBER_BOLT_ENCHANT_KINDS];
